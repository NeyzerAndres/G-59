...
class ChangePasswordView(PasswordChangeView):
    template_name = 'home\contrasena.html'
    success_url = reverse_lazy('home_app:general')
    form_class = PasswordChangeForm  # Utiliza PasswordChangeForm proporcionado por Django
